...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey('self', verbose_name='父类别', null=True, blank=True, related_name='sub_cat')
...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(verbose_name=u'商品描述', imagePath='goods/images/', width=1000, height=300, filePath='goods/files/', default='')
    ship_free = models.BooleanField(default=True, verbose_name='收费承担运费')
    goods_front_img = models.ImageField(upload_to='', null=True, blank=True, verbose_name='商品封面图')
